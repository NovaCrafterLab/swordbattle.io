  ...
  return (
    <div className="changelog">
      ...
      <ul style={{ fontSize: 22, color: '#ffffcc' }}>
        🎮 <span style={{ color: '#ffff00' }}>Swordbattle.io</span> is now live
        on <span style={{ color: '#00ff88' }}>Nova Crafter Lab</span>!
      </ul>
      <ul style={{ fontSize: 15, color: '#ffffee' }}>
        - Welcome to our revolutionary Web3 gaming platform
      </ul>
      <ul style={{ fontSize: 15, color: '#ffffee' }}>
        - Introducing <span style={{ color: '#00ff88' }}>Gameme</span> - where
        gaming meets meme culture
      </ul>
      <ul style={{ fontSize: 15, color: '#ffffee' }}>
        - We're pioneering the fusion of viral memes with engaging gameplay
      </ul>
      <br></br>
      <ul style={{ fontSize: 18, color: '#77aaff' }}>🚀 What is Gameme?</ul>
      <ul style={{ fontSize: 14, color: '#cccccc' }}>
        - Gameme combines the viral nature of memes with the addictive fun of
        gaming
      </ul>
      <ul style={{ fontSize: 14, color: '#cccccc' }}>
        - Our platform leverages meme culture's spreadability to promote Web3
        adoption
      </ul>
      <ul style={{ fontSize: 14, color: '#cccccc' }}>
      ...
      <br></br>
      <ul style={{ fontSize: 16, color: '#ffaa00' }}>🎯 Our Mission</ul>
