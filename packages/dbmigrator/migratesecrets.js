...
const sql2 = !ignoreNewDb
  ? postgres(process.env.NEW_DB, {
      ssl: {
...
let newUsers = !ignoreNewDb
  ? await sql2`SELECT * FROM accounts where is_v1 = true`
  : [];
